...
export default function PressDisplay({ articles }: { articles: Article[] }) {
  ...
  return (
    <section ref={sectionRef} id="press" className="py-28 lg:py-36 bg-cream">
      <div className="px-6 md:px-12 lg:px-20">
        ...
        <div className="press-grid grid grid-cols-1 md:grid-cols-3 gap-px bg-ink/8">
          {articles.map((article, i) => (
            <article key={article.id ?? i} className="article-card bg-cream group">
              <a href={article.href} target="_blank" rel="noopener noreferrer" className="flex flex-col h-full p-8">
